...
public class SkillBase : MonoBehaviour
{
    ...
    public void ReduceCooldownBy(float cooldownToReduce) => _lastTimeSkillUsed += cooldownToReduce;

    public void ResetCooldown() => _lastTimeSkillUsed = Time.time - cooldown;
}
